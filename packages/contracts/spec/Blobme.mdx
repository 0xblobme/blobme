...
The EIP-4844 protocol, supported by the Ethereum Cancun upgrade, defines blob-carrying transactions.
...
opening up endless possibilities for Ethereum's continuous scaling.
